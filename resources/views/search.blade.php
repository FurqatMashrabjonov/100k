...
@section("content")
    ...
    <div class="container m-auto">
        ...
        <div class="lg:m-0 -mx-5 flex justify-between py-4 relative space-x-3 uk-sticky dark-tabs"
            ...
            <div class="flex overflow-x-scroll lg:overflow-hidden lg:pl-0 pl-5 space-x-3">
                @foreach($types as $type)
                    <a onclick="search({{$type->id}})" href="#"
                       class="bg-white py-2 px-4 rounded inline-block font-bold shadow">{{$type->description}}</a>
                @endforeach
            </div>
                    ...
                    <li>
                        <a href="#" uk-toggle="target: #offcanvas-preview">
                            <div class="market-list">
                                <div class="item-media"><img src="{{pImgUrl($product)}}" alt=""></div>
        ...
        <div class="flex justify-between mt-6 mb-4">
            <h1 class="lg:text-2xl text-lg font-extrabold leading-none text-gray-900 tracking-tight"> Brand
                Collection </h1>
            <a href="#" class="text-blue-400 hover:text-blue-500"> See all</a>
        </div>
