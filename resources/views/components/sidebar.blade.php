  ...
  <div class="sidebar_inner" data-simplebar>
    <div class="flex flex-col items-center my-6 uk-visible@s">
      ...
      <div class="bg-gradient-to-tr from-yellow-600 to-pink-600 p-1 rounded-full transition m-0.5 mr-2  w-24 h-24">
        <img src="{{uImgUrl(auth()->user())}}" class="bg-gray-200 border-4 border-white rounded-full w-full h-full">
      </div>
      <a href="{{url('home')}}" class="text-xl font-medium capitalize mt-4 uk-link-reset"> {{auth()->user()->full_name}}
      </a>
      @else
      <div class="bg-gradient-to-tr from-yellow-600 to-pink-600 p-1 rounded-full transition m-0.5 mr-2  w-24 h-24">
        <img src="{{asset("img/user.png")}}" class="bg-gray-200 border-4 border-white rounded-full w-full h-full">
      </div>
      <a href="{{url('home')}}" class="text-xl font-medium capitalize mt-4 uk-link-reset"> Click to Login
      </a>
      @endif
