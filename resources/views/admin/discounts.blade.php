            ...
            <div class="toolbox__row row gutter-bottom-xs">
                ...
                <div class="toolbox__right col-12 col-lg-auto">
                    <div class="toolbox__right-row row row--xs flex-nowrap">
                        ...
                        <div class="col-auto">
                            <button class="button-add button-add--blue" data-modal="#addDiscount"><span
                ...
                <table class="table table--lines">
                    ...
                    @foreach($discounts as $discount)
                        <tr class="table__row">
                            ...
                            <td class="table__td">@php if ($discount->type == \App\Models\Discount::PERCENT) echo $discount->value . "%"; else if ($discount->type == \App\Models\Discount::SUMM) echo price_format($discount->value); @endphp</td>
