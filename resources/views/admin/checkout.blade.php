                ...
                <table style="padding: 10px;" class="table table--lines">
                    ...
                    @foreach($checkouts as $checkout)
                        <tr class="table__row">
                            ...
                            <td class="d-lg-table-cell table__td"><strong>{{$checkout->id}}</strong>
                            </td>
                            <td class="d-lg-table-cell table__td"><span>{{$checkout->region->name}}</span>
                            </td>
                            <td class="d-lg-table-cell table__td"><span>{{phone_format($checkout->phone)}}</span>
                            </td>
                            <td class="d-sm-table-cell table__td">
                                <span class="table__status-icon ">{{$checkout->name}}</span>
                            ...
                            <td class="d-sm-table-cell table__td">
                                <div class="table__status"><a href="{{url("product/" . $checkout->product_id)}}"><span
                                                class="table__status-icon">{{$checkout->product_id}}</span></a>
                                </div>
                            </td>
                            <td class="d-sm-table-cell table__td">
                                                           <span
                            ...
                            <td class="d-sm-table-cell table__td">
                                <div class="table__status">
                                    ...
                                    @if((int)$checkout->status === \App\Models\Checkout::NOT_SALED)
                                        <span class="table__status-icon color-dark"></span>
                                    @endif

                                    @if((int)$checkout->status === \App\Models\Checkout::SALED)
                                        <span class="table__status-icon color-grey"></span>
                                    @endif

                                    @if((int)$checkout->status === \App\Models\Checkout::DELIVING)
                                        <span class="table__status-icon color-green"></span>
                                    @endif

                                    @if((int)$checkout->status === \App\Models\Checkout::NOT_ACCEPTED)
                                        <span class="table__status-icon color-blue"></span>
                                    @endif

                                    @if((int)$checkout->status === \App\Models\Checkout::IGNORE)
                                        <span class="table__status-icon color-red"></span>
                                    @endif

                                    {{$checkout->with_status->description}}
                                </div>
                            </td>
                                            ...
                                            <ul class="dropdown-items__list">
                                                <li class="dropdown-items__item">
                                                    <a href="#" data-modal="#addRequest"
                                                       onclick="addRequest({{$checkout->id}})"
                                                ...
                                                @if((int)$checkout->status === \App\Models\Checkout::NOT_SALED)
                                                    ...
                                                    <li class="dropdown-items__item"><a class="dropdown-items__link"
                                                                                        href="{{url("admin/checkout_saled/" . $checkout->id)}}">Yetkazildi</a>
                                                    </li>
                                                    <li class="dropdown-items__item"><a class="dropdown-items__link"
                                                                                        href="{{url("admin/checkout_salling/" . $checkout->id)}}">Yetkazilmoqda</a>
                                                    </li>
                                                    <li class="dropdown-items__item"><a class="dropdown-items__link"
                                                                                        data-modal="#addProductSuccess"
                                                                                        onclick="toLocal({{$checkout->id}})">Bekor
                                                            qilish</a>
                                                    </li>
                                                @endif
                                                ...
                                                @if((int)$checkout->status === \App\Models\Checkout::NOT_ACCEPTED)
                                                    <li class="dropdown-items__item"><a class="dropdown-items__link"
                                                                                        href="{{url("admin/checkout_accepted/" . (int)$checkout->id)}}">Qabul
                                                            qilish</a>
                                                    </li>
                                                @endif
