            ...
            <div class="table-wrapper__content table-products table-collapse scrollbar-thin scrollbar-visible"
                ...
                <table class="table table--lines">
                    ...
                    @foreach($users as $user)
                        <tr class="table__row">
                            <td class="table__td">
                                <img src="{{uImgUrl($user)}}" alt="">
                            </td>
                            <td class="d-none d-lg-table-cell table__td"><span class="text-grey">{{$user->id}}</span>
                            </td>
                            <td class="table__td">{{ $user->full_name }}</td>
                            <td class="table__td"><span class="text-grey">{{phone_format($user->phone)}}</span>
                            </td>
                            <td class="table__td"><span>{{ price_format($user->balance) }}</span>
                            </td>
                            <td class="d-none d-lg-table-cell table__td"><span
                                    class="text-grey">{{ $user->created_at }}</span>
                            </td>
                            <td class="d-none d-sm-table-cell table__td">
                                <div class="table__status"><span
                                        class="table__status-icon color-red"></span>{{$user->full_address}}
                                </div>
                            </td>
