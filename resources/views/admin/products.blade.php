                ...
                <table class="table table--lines">
                    ...
                    @foreach($products as $product)
                        <tr class="table__row">
                            ...
                            <td class="table__td">{{ substr($product->name, 0, 30) . "..." }}</td>
                            <td class="table__td"><span class="text-grey">{{$product->type->name}}</span>
                            </td>
                            <td class="table__td"><span>{{price_format($product->price)}}</span>
                            </td>
                            <td class="d-none d-lg-table-cell table__td"><span
                                    class="text-grey">{{ $product->created_at }}</span>
                            </td>
                            <td class="d-none d-sm-table-cell table__td">
                                <div class="table__status"><span
                                        class="table__status-icon color-red"></span>{{$product->status->description}}
                                </div>
                            </td>
                            <td class="table__td table__actions">
                                <button onclick="updateProduct({{json_encode($product)}})" class="button-add button-add--blue" data-modal="#updateProduct"><span
                                            class="button-add__icon">
