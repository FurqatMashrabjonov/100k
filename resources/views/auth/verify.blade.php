...
@section('content')
    ...
    <div class="lg:p-12 max-w-md max-w-xl lg:my-0 my-12 mx-auto p-6 space-y-">
        <h1 class="lg:text-3xl text-xl font-semibold  mb-6"> Verify</h1>
        <form action="{{route("verify")}}" method="post">
            @csrf
            <label for="phone1"> <p class="mb-2 text-black text-lg">SMS verification code</p></label>
            ...
            @endif
            <button type="submit" class="bg-gradient-to-br from-pink-500 py-3 rounded-md text-white text-xl to-red-400 w-full">Submit</button>
            <div class="text-center mt-5 space-x-2">
                <p class="text-base"><a href="{{url("verify")}}" class=""> Resend code </a></p>
            </div>
        </form>
    </div>
