            ...
            <div class="table-wrapper__content table-products table-collapse scrollbar-thin scrollbar-visible"
                ...
                <table class="table table--lines">
                    ...
                    <tr class="table__header-row">
                        <th>
                            <span class="align-middle">Avatar</span><span class="sort sort--down"></span>
                        </th>
                        <th class="d-none d-lg-table-cell"><span>ID</span>
                        </th>
                        <th class="table__th-sort"><span class="align-middle">Full name</span><span
                                class="sort"></span>
                        </th>
                        <th class="table__th-sort"><span class="align-middle">Phone</span><span
                                class="sort"></span>
                        </th>
                        <th class="table__th-sort"><span class="align-middle">Balance</span><span
                                class="sort"></span>
                        </th>
                        <th class="table__th-sort"><span class="align-middle">Date register</span><span
                                    class="sort"></span>
                        </th>
                        <th class="table__th-sort d-none d-lg-table-cell"><span class="align-middle">Address</span><span
                                class="sort"></span>
                        </th>
                    ...
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="table__row">
                            <td class="table__td">
                                <img src="<?php echo e(uImgUrl($user)); ?>" alt="">
                            </td>
                            <td class="d-none d-lg-table-cell table__td"><span class="text-grey"><?php echo e($user->id); ?></span>
                            </td>
                            <td class="table__td"><?php echo e($user->full_name); ?></td>
                            <td class="table__td"><span class="text-grey"><?php echo e(phone_format($user->phone)); ?></span>
                            </td>
                            <td class="table__td"><span><?php echo e(price_format($user->balance)); ?></span>
                            </td>
                            <td class="d-none d-lg-table-cell table__td"><span
                                    class="text-grey"><?php echo e($user->created_at); ?></span>
                            </td>
                            <td class="d-none d-sm-table-cell table__td">
                                <div class="table__status"><span
                                        class="table__status-icon color-red"></span><?php echo e($user->full_address); ?>
...
<?php echo $__env->make("admin.layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/u1382474/baraka-shop.uz/resources/views/admin/users.blade.php ENDPATH**/ ?>