                      ...
                      <svg class="icon-icon-arrow-down">
                        ...
                        <div class="lang-menu dropdown-menu">
                            <button class="lang-menu__button dropdown-menu__item" tabindex="0">
                                <img class="lang-menu__icon" src="<?php echo e(asset("admin/img/content/flags/ru.svg")); ?>" alt="#" /><span class="lang-menu__text">Ru</span>
                            </button>
                        </div>
                    </div>
                                        ...
                                        <a class="dropdown-menu__item-block dropdown-menu__message" href="#">
                                            ...
                                            <div class="dropdown-menu__item-right">
                                                <div class="dropdown-menu__item-column">
                                                    <h4 class="dropdown-menu__item-title"><?php echo e(auth()->user()->full_name); ?></h4>
                    ...
                    <div class="header__profile dropdown">
                        <a class="header__profile-toggle dropdown__toggle" href="#" data-toggle="dropdown">
                            <div class="header__profile-image"><span class="header__profile-image-text">MA</span>
                                <img src="<?php echo e(asset("avatars/" . auth()->user()->avatar)); ?>" alt="#" />
                            </div>
                            <div class="header__profile-text"><span><?php echo e(auth()->user()->full_name); ?></span>
                        ...
                        <svg class="icon-icon-settings">
                          <use xlink:href="#icon-settings"></use>
                            ...
                            <form action="<?php echo e(route('logout')); ?>" method="post">
                                ...
                                <button type="submit"><a class="profile-dropdown__item dropdown-menu__item" href="#" tabindex="0"><span class="profile-dropdown__icon">
                        <svg class="icon-icon-logout">
                          <use xlink:href="#icon-logout"></use>
                        </svg></span><span>Logout</span></a></button>
                            </form>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /var/www/u1382474/baraka-shop.uz/resources/views/admin/components/header.blade.php ENDPATH**/ ?>