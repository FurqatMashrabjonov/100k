        ...
        <div class="sidebar__content" data-simplebar="data-simplebar">
            <nav class="sidebar__nav">
                <ul class="sidebar__menu">
                    <li class="sidebar__menu-item"><a class="sidebar__link " href="<?php echo e(url("admin/dashboard")); ?>"><span class="sidebar__link-icon">
                      <svg class="icon-icon-dashboard">
                        <use xlink:href="#icon-dashboard"></use>
                      </svg></span><span class="sidebar__link-text">Dashboard</span></a>
                    </li>
                    <li class="sidebar__menu-item"><a class="sidebar__link " href="<?php echo e(url("admin/products")); ?>" ><span class="sidebar__link-icon">
                      <svg class="icon-icon-cart">
                        <use xlink:href="#icon-cart"></use>
                      </svg></span><span class="sidebar__link-text">Products</span><span class="sidebar__link-arrow">
                     </span></a>
                    </li>
                    <li class="sidebar__menu-item"><a class="sidebar__link" href="<?php echo e(url('admin/checkouts')); ?>" aria-expanded="false"><span class="sidebar__link-icon">
                     <svg class="icon-icon-todo">
                        <use xlink:href="#icon-todo"></use>
                      </svg></span><span class="sidebar__link-text">Checkouts</span></a>
                    </li>
                    <li class="sidebar__menu-item"><a class="sidebar__link" href="<?php echo e(url('admin/payments')); ?>" aria-expanded="false"><span class="sidebar__link-icon">
                      <svg class="icon-icon-email">
                        <use xlink:href="#icon-email"></use>
                      </svg></span><span class="sidebar__link-text">Payments</span></a>
                    </li>
                    <li class="sidebar__menu-item"><a class="sidebar__link" href="<?php echo e(url("admin/discounts")); ?>" aria-expanded="false"><span class="sidebar__link-icon">
                      <svg class="icon-icon-chat">
                        <use xlink:href="#icon-chat"></use>
                      </svg></span><span class="sidebar__link-text">Discounts</span></a>
                    </li>
                    <li class="sidebar__menu-item"><a class="sidebar__link" href="<?php echo e(url("admin/users")); ?>" aria-expanded="false"><span class="sidebar__link-icon">
                      <svg class="icon-icon-contacts">
                        <use xlink:href="#icon-contacts"></use>
                      </svg></span><span class="sidebar__link-text">Users</span></a>
                    </li>
                    <li class="sidebar__menu-item"><a class="sidebar__link" href="<?php echo e(url('admin/types')); ?>" aria-expanded="false"><span class="sidebar__link-icon">
                      <svg class="icon-icon-todo">
                        <use xlink:href="#icon-todo"></use>
...
<?php /**PATH /var/www/u1382474/baraka-shop.uz/resources/views/admin/components/sidebar.blade.php ENDPATH**/ ?>