        ...
        <div class="flex flex-col items-center my-6 uk-visible@s">
            <?php if(auth()->check()): ?>
                <div class="bg-gradient-to-tr from-yellow-600 to-pink-600 p-1 rounded-full transition m-0.5 mr-2  w-24 h-24">
                    <img src="<?php echo e(uImgUrl(auth()->user())); ?>"
                         class="bg-gray-200 border-4 border-white rounded-full w-full h-full">
                </div>
                <a href="<?php echo e(url('home')); ?>"
                   class="text-xl font-medium capitalize mt-4 uk-link-reset"> <?php echo e(auth()->user()->full_name); ?>
                ...
                <div class="flex justify-around w-full items-center text-center uk-link-reset text-gray-800 mt-6">
                    <div>
                        <a href="#">
                            ...
                            <div><?php echo e(price_format(auth()->user()->balance)); ?></div>
                        </a>
                    </div>
                    <div>
                        <a href="#">
                            <strong>Oqimlarim</strong>
                            <div><?php echo e(auth()->user()->referals); ?></div>
                        </a>
                    </div>
                </div>
            <?php else: ?>
...
" href="<?php echo e(url('home')); ?>" class="text-xl font-medium capitalize mt-4 uk-link-reset">
        ...
        <div class="sidebar_inner" data-simplebar>
            ...
            <?php if(auth()->check()): ?>
                <ul>
                    ...
                    <li>
                        <a href="<?php echo e(url("profile/admin/market")); ?>">
                            <i class="uil-store"></i>
                            <span> Do'kon </span> </a>
                    </li>
                    <li>
                        <a href="<?php echo e(url("profile/settings")); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                 stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
</script><?php /**PATH /var/www/u1382474/baraka-shop.uz/resources/views/components/sidebar.blade.php ENDPATH**/ ?>